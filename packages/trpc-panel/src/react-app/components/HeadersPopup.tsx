...
export function HeadersPopup() {
    ...
    >
      ...
      <DialogContent dividers>
        <form
          ...
          className="w-full flex flex-col rounded-md space-y-4"
        >
  ...
  // return (
  //   <Box className='fixed flex left-0 right-0 top-0 bottom-0 items-center border drop-shadow-lg justify-center  bg-opacity-70'>
