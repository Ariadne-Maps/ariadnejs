...
function SearchInput() {
  ...
  return (
    <Box
      ...
      className="min-w-[40rem] pointer-events-auto overflow-visible rounded-md flex flex-col border-neutralBgVeryDark border drop-shadow-md p-1 rounded-t-md z-50"
    >
      <TextField
        size="small"
        className="p-1 rounded-sm border self-stretch "
        value={searchText}
